...
;;    /* Class specific Uncompressed VS format descriptor */
     ...
     dw     5955H;4e56H;5955H	
     dw     5932H ;3132H;5932H      ;;    /* GUID used to identify streaming-encoding format: YUY2  */
     dw     0000H
     dw     1000H      ;;
     dw     8000H
     dw     00AAH      ;;
     ...
     db     01H;08H             ;;            /* X dimefion of the picture aspect ratio: Non-interlaced in
	 	         	        ;;           progressive scan */
     db     01H;06H             ;;            /* Y dimension of the picture aspect ratio: Non-interlaced in
	                  	    ;;	   progressive scan*/
...
;;    /* Class specific Uncompressed VS Frame descriptor */
     ...
     dw     0c00H;8002H           ;;         /* Width in pixel: 320-QVGA */
     dw     0c00H;0E001H           ;;         /* Height in pixel 240-QVGA */
     dw     0000H
     dw     0100H;0CA08H       ;;   /* Min bit rate bits/s. Not specified, taken from MJPEG */
     dw     0FFFFH;0000H
     dw     0FFFFH;0CA08H       ;;   /* Max bit rate bits/s. Not specified, taken from MJPEG */
     dw     0FFFFH;0060H
     dw     0FFFFH;0900H       ;;   /* Maximum video or still frame size in bytes(Deprecated) */
     dw     1027H;1516H
     dw     0000H;0500H       ;;   /* Default Frame Interval */
     db     01H               ;;        /* Frame interval(Frame Rate) types: Only one frame interval supported */
     dw     1027H;1516H
     dw     0000H;0500H       ;;   /* Shortest Frame Interval */    
